 ...
 *
 * Цен на карточке нет: стоимость проекта называется после разбора задачи.
 * Условия, которые владелец готов назвать заранее — часовая ставка, вилки
 * поддержки, порядок оплаты, — живут в FAQ (`data/faq.ts`), а не здесь:
 * витрина направлений отвечает на «что я получу», а не «сколько это стоит».
 *
