 ...
 *
 * Действия «скопировать почту» из таблицы §14 здесь нет. Почта `info@jw-dev.pro`
 * появилась 04.09.2026, но копирование — это буфер обмена, тост и запасной путь
 * без JS, а не строчка в этом списке: все действия ниже суть ссылки. Отдельная
 * задача, стоит в Ф12.
 */
