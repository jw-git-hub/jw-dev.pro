...
`frameP95` в 30 мс, с 01.09.2026 — занятостью главного потока, порог 55% прокрутки.
Величину пришлось сменить: длительность кадра квантована развёрткой и краснела
от загрузки машины, а не от страницы. Цифры в таблице выше — замер того дня, они
не пересняты и остаются историей правки.
